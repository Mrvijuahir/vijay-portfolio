...
const email = "vahir9487@gmail.com";
const phone = "+91 9925876005";
  ...
  return (
    <SectionLayout id="contact">
      <Box display={"flex"} flexDirection={"column"} alignItems={"center"}>
        <PrimaryHeader highlightedText="Connect 🤝">Let’s</PrimaryHeader>
        <br />
        <SecondaryText>
          What’s next? 🚀 Looking for a developer, have a question, or just want
          to connect? Let’s talk! <br /> Let’s turn ideas into code 💻✨ — reach
          out!
        </SecondaryText>
        <StyledBox mt={"2rem"}>
          <Mail />
